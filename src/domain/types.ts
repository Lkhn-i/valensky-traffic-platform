...
export type TariffId = "zero" | "workshop" | "basic" | "mentor" | "vip";
...
export type VideoProvider = "external" | "kinescope";
...
export interface Lesson extends BaseEntity {
  ...
  kinescopePlayerId?: string;
  kinescopeUseDrmAuth?: boolean;
  kinescopeUseWatermark?: boolean;
  blockIds: string[];
  materialIds: string[];
...
export interface LessonProgress {
  ...
  completionAcknowledgementText?: string;
  updatedAt: string;
}
...
export interface AccessResult {
  ...
  message: string;
  availableAt?: string;
  dependsOnLessonTitle?: string;
  dependsOnAvailableAt?: string;
}
